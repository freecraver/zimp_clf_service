...
class AbstractTest(object):
    class BaseSklearnTest(unittest.TestCase, ABC):
        ...
        def test_train(self):
            with open('res/train.csv', 'rb') as f:
                data = {**self.get_train_parameters(), 'file': f}
        ...
        def test_predict_proba(self):
            ...
            self.assertTrue(predictions[0].get('probability') > 0.5)
        ...
        def test_predict_proba_multiple(self):
            ...
            self.assertTrue(predictions[0].get('labels')[0].get('probability') > 0.5)
        ...
        def test_download_model(self):
            ...
            with tempfile.TemporaryDirectory() as td:
                ...
                pipeline = load(f_name)  # assumes sklearn model
